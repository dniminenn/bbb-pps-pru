...
8. **[Clock Domains & Synchronization](docs/clock-domains.md)** — IEP↔wall correlation, memory mechanism, ordering guarantees
9. **[Measurements & Validation](docs/measurements.md)** — Expected performance, how to reproduce, diagnostic guidance
